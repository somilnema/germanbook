...
export default function ContactPage() {
  ...
  const scrollToSection = (sectionId: string) => {
    // This is a placeholder since we are on a separate page
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-background via-secondary/5 to-background pt-32 pb-12">
